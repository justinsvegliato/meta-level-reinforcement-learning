from rlts.runners.dqn_runner import DQNRun
from rlts.meta.meta_env import mask_token_splitter
from rlts.networks.search_q_net import SearchQNetwork
from rlts.networks.search_actor_nets import SearchActorNetwork
from rlts.networks.search_value_net import SearchValueNetwork
from rlts.meta.meta_env import MetaEnv
from rlts.meta.search_tree import QFunction, SearchTree, ObjectState
...
def create_meta_env(object_env: gym.Env,
    ...
    meta_env = MetaEnv(object_env,
                       ...
                       compute_meta_rewards=config.get('compute_meta_rewards', True),
                       create_intermediate_search_policies=config.get('create_intermediate_search_policies', True),
                       ...
                       object_env_discount=config.get('object_discount', .99),
