...
from rlts.meta.search_tree import SearchTree, SearchTreeNode, ObjectState, find_cycle
...
class SearchTreePolicy(ABC):
    ...
    def __init__(self,
        ...
        from rlts.meta.q_estimation import SearchOptimalQEstimator
...
class GreedySearchTreePolicy(SearchTreePolicy):
    ...
    def __init__(self,
        ...
        from rlts.meta.q_estimation import DeterministicOptimalQEstimator
